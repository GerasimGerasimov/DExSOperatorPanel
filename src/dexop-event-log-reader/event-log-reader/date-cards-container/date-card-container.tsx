...
import { TDatesQuery } from "../../event-models/dates/dates-queries";
import { IQueryDirection, ISortDirection } from "../../event-models/sort-conditions";
import { ISearchDateRangeQuery } from "../../../interfaces/ISearchDateRangeQuery";
import { IDatesQuery } from "../../../interfaces/IDatesQuery";
import { IDatesRespond } from "../../../interfaces/IDatesRespond";
  ...
  private getNextIndex (direction: IQueryDirection): number {
    ...
    switch (direction) {
      case IQueryDirection.Next:
        ...
        const max: number =
          (this.state.respond.TotalItemsQuantity === 0)
          ? 0
