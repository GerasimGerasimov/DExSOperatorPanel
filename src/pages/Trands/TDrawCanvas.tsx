...
export default class Canvas extends Component <IDrawCanvasProps, {}> {
  ...
  saveContext (element: any) {
    ...
    const width: number = element.clientWidth; // integer
    const height: number = element.clientHeight; // integer
  ...
  private getLegendItems (fromIndex: number, source: Array<ILegendItem>, model: TViewBoxModel): Array<ILegendItem> { // gets consanlty updating data from device
