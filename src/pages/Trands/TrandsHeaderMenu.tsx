...
export interface ITrandsHeaderMenuProps {
...
export default class TrandsHeaderMenu extends Component <ITrandsHeaderMenuProps,{}> {
  private ToolMenu: Array<IToolButtonProps> = [
    ...
    { name: 'PlayPause', type:'TougleButton', icon:['fa-pause-circle','fa-play-circle'], isTougle: this.props.isTougle,//Trands.Run,
      onClick:this.props.ToolMenuHandler},
    { name: 'ZoomMinus', type:'ToolButton', icon:['fa-search-minus'],  onClick:this.props.ToolMenuHandler},
