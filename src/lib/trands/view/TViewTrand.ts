import { ITrandTagProperties } from "../../../interfaces/ITrandTagProperties";
import { IViewTrandDrawMethodProps } from "../../../interfaces/IViewTrandDrawMethodProps";
import { IViewTrandProps } from "../../../interfaces/IViewTrandProps";
import { IViewTrandScalesProps } from "../../../interfaces/IViewTrandScalesProps";
import { IViewTrandSizeProps } from "../../../interfaces/IViewTrandSizeProps";
...
export abstract class TViewTrand {
  ...
  protected Sizes: IViewTrandSizeProps;
  protected model: TModel;
  protected deep: number;

  constructor (props: IViewTrandProps) {
  ...
  public getStartPosition (index: number, offset: number): number {
    const revOffset: number = offset;
    let res: number = index - this.Sizes.count - revOffset;
    const mod: number = res % this.deep;
    if (res < 0) {
  ...
  public resize (sizes: IViewTrandSizeProps): void {
